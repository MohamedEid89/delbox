              ...
              <div class="login-main"> 
                ...
                <form class="theme-form" method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    <label class="col-form-label pt-0" for="name"  value="{{ __('name')}}"" >Your Name</label>
                    <div class="row g-2">
                      <div class="col-12">
                        <input class="form-control" name="name" type="text" id="name"   value="{{ old(__('name'))}}"  required="" placeholder="Your full name">
                        @if ($errors->has('name'))
                  ...
                  <div class="form-group">
                    <label class="col-form-label" id="email" value="{{ __('name')}}"">{{ __('Email') }}</label>
                    <input class="form-control" name="email" type="email" id="email" value="{{ old(__('email'))}}" required="" placeholder="email@gmail.com">
                    @if ($errors->has('email'))
                    <div class="text-danger mt-2">
                        {{ $errors->first('email') }}
                    </div>
    ...
    <div class="show-hide" onclick="togglePassword()">
      <i id="eye-icon" class="fas fa-eye"></i> <!-- Font Awesome Eye Icon -->
                  ...
                  <div class="form-group mb-0">
                    <button class="btn btn-primary btn-block w-100 mt-2 p-2 fw-bold" type="submit">{{ __('Register') }}</button>
                  </div>
